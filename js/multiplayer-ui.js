...
export class MultiplayerUI {
  ...
  syncCamMode(mode) {
    ...
    const CAM_LABELS = { 'board-face': 'Board - Face', 'king-cam': 'King - Cam', 'split-cam': 'Split Cam', 'split-cam-h': 'Split H', 'none': 'No-Cam' };
  ...
  showSettingChanged(payload) {
    ...
    if (payload.field === 'camMode' && this.inlineCamBtn) {
      const CAM_LABELS = { 'board-face': 'Board Face', 'split-cam': 'Split Cam', 'split-cam-h': 'Split H', 'king-cam': 'King Cam', 'none': 'No Cam' };
